...
$id=$_GET['id'];
$s="select * from detail where id='$id'";
...
if(isset($_POST['Submit'])){
  ...
  // }
	...
	if($c==0)
	{
		$insert="update  detail set cat_id='$cat_id',name='$name', price='$price',image='$location', image1='$location1' where id ='$id'";
		$exe= mysqli_query($conn,$insert);
		if($exe){
			echo "<script>alert('one record updated'); window.location='manageDetail.php'</script>";
