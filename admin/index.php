        ...
        include "include/connectivity.php";
         function getRecords($conn,$tablename)
		{
...
?>
     	...
     	<div class="col_3">
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                    ...
                    <div class="stats">
                    	<a href="manageRegister.php">
                      <h5><strong><?php echo getRecords($conn,"register")?></strong></h5>
                      <span>New Registered Users</span></a>
                    </div>
                </div>
        	</div>
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                    ...
                    <div class="stats">
                      ...
                      <h5><strong><?php echo getRecords($conn,"contact")?></strong></h5>
                      <span>Enquiry</span></a>
                    </div>
                </div>
        	</div>
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                    ...
                    <div class="stats">
                      ...
                      <h5><strong><?php echo getRecords($conn,"category")?></strong></h5>
        	...
        	<div class="col-md-3 widget">
        		<div class="r3_counter_box">
                    ...
                    <div class="stats">
                    	<a href="manageDetail.php">
                      <h5><strong><?php echo getRecords($conn,"detail")?></strong></h5>
                      <span>Prouct Details</span>
                  </a>
                    </div>
                </div>
        	 </div>
      ...
      <div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                    <i class="pull-left fa fa-users user1 icon-rounded"></i>
                    <div class="stats">
                    	<a href="managePres.php">
                      <h5><strong><?php echo getRecords($conn,"pres_nonpres")?></strong></h5>
                      <span>Prescription detail</span></a>
                    </div>
                </div>
        	</div>
        	...
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                    ...
                    <div class="stats">
                      ...
                      <h5><strong><?php echo getRecords($conn,"feedback")?></strong></h5>
                      <span>Feedback detail</span></a>
                    </div>
                </div>
        	</div>
      <div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                    ...
                    <div class="stats">
                      ...
                      <h5><strong><?php echo getRecords($conn,"cart")?></strong></h5>
                      <span>Cart detail</span></a>
                    </div>
                </div>
        	</div>
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                    ...
                    <div class="stats">
                      ...
                      <h5><strong><?php echo getRecords($conn,"card")?></strong></h5>
                      <span>Card detail</span></a>
                    </div>
                </div>
        	</div>
