...
if(isset($_POST['Submit'])){
  ...
  echo $c;
	if($c==0)
	{
		if(($password==$opass)&&($npass==$cpass)){
		$insert="update register set Password='$npass' where Email='$email'";
		$exe= mysqli_query($conn,$insert);
		if($exe){
			echo "<script>alert('Password has been changed');window.location='logout.php';</script>";
      ...
      <div class="container">
        ...
        <div class="graphs">
	     <div class="xs">
            ...
            <div class="row mb-5">
              <div class="col-md-12">
                <!-- <h2 class="h3 mb-3 text-black">Password</h2> -->
                <!-- included second form-->
                <div class="p-3 p-lg-5 border">
    
                 <div class="form-group row">
                      <div class="col-md-12">
                        <label for="c_diff_companyname" class="text-black">Old Password</label>
                        <input type="password" class="form-control" id="c_diff_companyname" name="opass" placeholder="Enter Email or phone number"><!-- <?php echo $err[0];?> -->
                      </div>
                    </div>
         <div class="form-group row">
                      <div class="col-md-12">
                        <label for="c_diff_companyname" class="text-black"> New Password</label>
                        <input type="password" class="form-control" id="c_diff_companyname" name="npass" placeholder="Enter Password"><!-- <?php echo $err[1];?> -->
                      </div>
        </div>
        <div class="form-group row">
                      <div class="col-md-12">
                        <label for="c_diff_companyname" class="text-black">Confirm Password</label>
                        <input type="password" class="form-control" id="c_diff_companyname" name="cpass" placeholder="Enter Password"><!-- <?php echo $err[1];?> -->
                      </div>
        </div>
                    ...
                    <input type="Submit" name="Submit" class="btn btn-primary btn-lg btn-block">
								...
								<!-- <div class="form-group">
									...
									<div class="col-sm-8">
										<input type="password" name="opass" class="form-control"  placeholder="Enter your old password">
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<label for="Confirm password" class="text-black">Confirm Password</label>
									<div class="col-sm-8">
